...
type BadgeVariant = "default" | "success" | "warning" | "info" | "brand" | "danger";
...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-lg px-2.5 py-0.5 text-xs font-semibold uppercase tracking-wide",
        variants[variant],
        className
      )}
      {...props}
